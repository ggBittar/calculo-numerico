"""Programa separado para executar o método: rk2_ponto_medio.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Executa o método rk2_ponto_medio para as malhas da avaliação.")
    ...
    for N in MESHES:
        print(f"Executando método=rk2_ponto_medio, Nx=Ny={N}, C={args.C:g}")
        result = run_simulation(method="rk2_ponto_medio", Nx=N, Ny=N, C=args.C, xp=xp, using_cuda=using_cuda, cfg=cfg)
