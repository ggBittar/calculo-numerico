"""Programa separado para executar o método: rk4.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Executa o método rk4 para as malhas da avaliação.")
    ...
    for N in MESHES:
        print(f"Executando método=rk4, Nx=Ny={N}, C={args.C:g}")
        result = run_simulation(method="rk4", Nx=N, Ny=N, C=args.C, xp=xp, using_cuda=using_cuda, cfg=cfg)
