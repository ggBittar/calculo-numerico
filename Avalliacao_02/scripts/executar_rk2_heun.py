"""Programa separado para executar o método: rk2_heun.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Executa o método rk2_heun para as malhas da avaliação.")
    ...
    for N in MESHES:
        print(f"Executando método=rk2_heun, Nx=Ny={N}, C={args.C:g}")
        result = run_simulation(method="rk2_heun", Nx=N, Ny=N, C=args.C, xp=xp, using_cuda=using_cuda, cfg=cfg)
